...
var Footer = function Footer(props) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            "a",
            { href: front_end_url, target: "_blank" },
            _react2.default.createElement("img", { src: "https://jayceecodesphotos.s3.amazonaws.com/react.png" })
        ),
        _react2.default.createElement(
            "a",
            { href: front_end_url, target: "_blank" },
            _react2.default.createElement("img", { src: "https://jayceecodesphotos.s3.amazonaws.com/redux.png" })
        ),
        _react2.default.createElement(
            "a",
            { href: front_end_url, target: "_blank" },
            _react2.default.createElement("img", { src: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Sass_Logo_Color.svg/2000px-Sass_Logo_Color.svg.png", style: { backgroundColor: "white", borderRadius: "10px" } })
        ),
        _react2.default.createElement(
            "a",
            { href: back_end_url, target: "_blank" },
            _react2.default.createElement("img", { src: _utils.logoUrl })
        ),
        _react2.default.createElement(
            "a",
            { href: back_end_url, target: "_blank" },
            _react2.default.createElement("img", { src: "http://pluspng.com/img-png/nodejs-logo-png-nice-images-collection-node-js-desktop-wallpapers-370.png" })
        ),
        _react2.default.createElement(
            "a",
            { href: back_end_url, target: "_blank" },
            _react2.default.createElement("img", { src: "https://cdn.iconscout.com/icon/free/png-512/redis-6-1175105.png" })
        ),
        _react2.default.createElement(
            "a",
            { href: back_end_url, target: "_blank" },
            _react2.default.createElement("img", { src: "https://jayceecodesphotos.s3.amazonaws.com/postgres.png" })
        ),
        _react2.default.createElement(
            "a",
            { href: back_end_url, target: "_blank" },
            _react2.default.createElement("img", { src: "https://jayceecodesphotos.s3.amazonaws.com/aws.png", style: { borderRadius: "10px" } })
        )
    );
};
...
var _thunks_for_User = __webpack_require__(/*! ../../store/User/thunks_for_User.js */ "./store/User/thunks_for_User.js");
  ...
  function Landing(props) {
    ...
    _this.handleSubmit = function (evt) {
      ...
      if (!re.test(email)) {
        ...
        _this.setState({ local_landing_page_error: "Invalid Email" });
        setTimeout(function () {
          return _this.setState({ local_landing_page_error: null });
        }, 5000);
        return;
      }
      ...
      if (password === "") {
        ...
        _this.setState({ local_landing_page_error: "Invalid Password" });
        setTimeout(function () {
          return _this.setState({ local_landing_page_error: null });
        }, 5000);
        return;
      ...
      if (_this.state.mode === "sign-up") {
        ...
        if (password !== _this.state.confirm_password) {
          ...
          _this.setState({ local_landing_page_error: "Passwords do not match" });
          setTimeout(function () {
            return _this.setState({ local_landing_page_error: null });
          }, 5000);
      ...
      _this.setState({ submitted: true, server_landing_page_error: true });
    };

    _this.handleMode = function (mode) {

      _this.setState({ mode: mode, server_landing_page_error: false, local_landing_page_error: null });
    };
  ...
  _createClass(Landing, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          mode = _state.mode,
          local_landing_page_error = _state.local_landing_page_error;
      ...
      if (this.props.isLoggedIn) {
        ...
        return _react2.default.createElement(_reactRouterDom.Redirect, { to: '/all/watchlist' });
      } else {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            isDesktop && mode === "sign-up" && _react2.default.createElement(
              'div',
              { className: 'sign-btns' },
              _react2.default.createElement(
                'span',
            ...
            isDesktop && mode == "sign-in" && _react2.default.createElement(
              'div',
              { className: 'sign-btns' },
              _react2.default.createElement(
                'span',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'form',
              null,
              mode === "sign-up" && _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(
                  'span',
              ...
              _react2.default.createElement(
                ...
                mode === 'sign-in' && !this.state.submitted ? "Sign In" : mode === 'sign-up' && !this.state.submitted ? "Sign Up" : this.state.submitted ? "Loading..." : ""
              ),
              server_landing_page_error && _react2.default.createElement(
                'span',
                { className: 'error-message' },
                this.props.server_landing_page_error
              ),
              local_landing_page_error && _react2.default.createElement(
                'span',
                { className: 'error-message' },
                local_landing_page_error
              ),
              mode === "sign-in" && _react2.default.createElement(
                'span',
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    handleLogin: function handleLogin(email, password) {
      return dispatch((0, _thunks_for_User.loginThunk)(email, password));
    },
    handleRegister: function handleRegister() {
      return dispatch(_thunks_for_User.registerThunk.apply(undefined, arguments));
    }
  };
};
...
var _actions_for_User = __webpack_require__(/*! ../../store/User/actions_for_User.js */ "./store/User/actions_for_User.js");

var _actions_for_User2 = _interopRequireDefault(_actions_for_User);
  ...
  _createClass(MainNav, [{
    ...
    value: function componentDidMount() {
      var _props = this.props,
          token = _props.token,
          hydratePortfolio = _props.hydratePortfolio;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'main-nav' },
        _react2.default.createElement(_Socket2.default, null),
        _utils.isDesktop && _react2.default.createElement(
          'div',
          { className: 'desk-nav' },
          _react2.default.createElement(
            'span',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            (0, _utils.isDesktop)() && _react2.default.createElement(
              'span',
              null,
              'Portfolio'
            )
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    LogOut: function LogOut() {
      return dispatch(_actions_for_User2.default.LogOut());
    },
...
var _thunks_for_Portfolio = __webpack_require__(/*! ../../../store/Portfolio/thunks_for_Portfolio */ "./store/Portfolio/thunks_for_Portfolio.js");
...
var IndivFin = function (_React$Component) {
  ...
  _createClass(IndivFin, [{
    ...
    value: function componentDidMount() {
      ...
      if (!(0, _utils.isCell)() && !selectedPortfolioItem_object.financials) {
    ...
    value: function render() {
      ...
      var _props3 = this.props,
          selectedPortfolioItem = _props3.selectedPortfolioItem,
          portfolio = _props3.portfolio;
      ...
      var no_financial_data = selectedPortfolioItem_object && selectedPortfolioItem_object.financials && selectedPortfolioItem_object.financials.length === 0;
      ...
      var selectedDataNavItem = void 0;
      ...
      return _react2.default.createElement(
        'div',
        null,
        is_Loaded && whichFinancial !== undefined ? _react2.default.createElement(
          'div',
          ...
          Object.entries(selectedPortfolioItem_object.financials[whichFinancial]).map(function (item, i) {
        ...
        ) : no_financial_data ? _react2.default.createElement(
          'span',
          ...
          _react2.default.createElement(_loadingDots2.default, { size: "10vh" })
        ),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    hydrateQuarterlyFinancialsThunk: function hydrateQuarterlyFinancialsThunk(symbol) {
      return dispatch((0, _thunks_for_Portfolio.hydrateQuarterlyFinancialsThunk)(symbol));
    }
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(IndivFin);
...
var IndivNav = function (_React$Component) {
  ...
  _createClass(IndivNav, [{
    ...
    value: function componentDidMount() {
      ...
      if ((0, _utils.isCell)() && !selectedPortfolioItem_object.historical) {
    ...
    value: function render() {
      ...
      var _props3 = this.props,
          selectedPortfolioItem = _props3.selectedPortfolioItem,
          portfolio = _props3.portfolio,
          handleSymbolSelect = _props3.handleSymbolSelect;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          (0, _utils.isCell)() ? _react2.default.createElement('i', { className: 'fas fa-bars fa-7x',
            onClick: function onClick() {
              return _this2.setState({ isModalShowing: true, whichModal: 'page-selector' });
            }
          }) : _react2.default.createElement('div', { style: { width: (0, _utils.isDesktop)() ? "1.7vw" : "7vw" } }),
          _react2.default.createElement(
            'div',
            {
              onClick: function onClick() {
                return _this2.setState({ isModalShowing: true, whichModal: 'symbol-selector' });
              }
            },
            _react2.default.createElement(
              'span',
              null,
              selectedPortfolioItem_object && selectedPortfolioItem_object.symbol
            ),
            _react2.default.createElement('i', { className: 'fas fa-angle-down fa-7x' })
          ),
          _react2.default.createElement(
            'span',
            {
        ...
        isModalShowing && _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            whichModal === 'page-selector' && _react2.default.createElement(_IndivSelector2.default, {
              pathname: pathname,
              exit: this.closeModal
            }),
            whichModal === 'trade-box' && _react2.default.createElement(_TradeBox2.default, {
              exit: this.closeModal
            }),
            whichModal === 'symbol-selector' && portfolio && _react2.default.createElement(
              'div',
              { onClick: function onClick(e) {
                  handleSymbolSelect(e.target.textContent);
                  _this2.setState({ isModalShowing: false });
                } },
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    hydrateSinglePortfolioPage: function hydrateSinglePortfolioPage() {
      return dispatch(_thunks_for_Portfolio.hydrateSinglePortfolioPage.apply(undefined, arguments));
    },
    handleSymbolSelect: function handleSymbolSelect(symbol) {
      return dispatch(_actions_for_Portfolio2.default.handleSymbolSelect(symbol));
    }
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(IndivNav);
...
var IndivNews = function (_React$Component) {
  _inherits(IndivNews, _React$Component);

  function IndivNews(props) {
    _classCallCheck(this, IndivNews);

    var _this = _possibleConstructorReturn(this, (IndivNews.__proto__ || Object.getPrototypeOf(IndivNews)).call(this, props));
  ...
  _createClass(IndivNews, [{
    ...
    value: function componentDidMount() {
      ...
      if (!(0, _utils.isCell)() && !selectedPortfolioItem_object.news) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        }) : no_news_data ? _react2.default.createElement(
          "span",
          { className: "error_message" },
          "Data Not Available"
        ) : _react2.default.createElement(
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    hydrateNewsThunk: function hydrateNewsThunk(symbol) {
      return dispatch((0, _thunks_for_Portfolio.hydrateNewsThunk)(symbol));
    }
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(IndivNews);
...
var PerformanceChart = (0, _react.lazy)(function () {
  return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(2)]).then(__webpack_require__.t.bind(null, /*! ./PerformanceChart */ "./app/components/indiv/PerformanceChart.js", 7));
});
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            null,
            '$ ',
            selectedPortfolioItem_object && selectedPortfolioItem_object.price ? selectedPortfolioItem_object.price : selectedPortfolioItem_object.data.latestPrice
          ),
          _react2.default.createElement(
            'span',
            null,
        ...
        selectedPortfolioItem_object && selectedPortfolioItem_object.price && _react2.default.createElement(
          'div',
          { className: 'first-datapoints' },
          [["Holdings", '' + current_holding], ["Value", '$' + (current_holding * selectedPortfolioItem_object.price).toFixed(2)]].map(function (item, i) {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _react.Suspense,
            { fallback: 'Loading...' },
            _react2.default.createElement(PerformanceChart, { period: chartPeriod(selectedDataNavItem) })
          )
        ),
        _react2.default.createElement(_DataNav2.default, {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    hydrateTimeSeriesDataThunk: function hydrateTimeSeriesDataThunk(symbol) {
      return dispatch((0, _thunks_for_Portfolio.hydrateTimeSeriesDataThunk)(symbol));
    }
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(IndivPerf);
...
var IndivTrans = function (_React$Component) {
  ...
  _createClass(IndivTrans, [{
    ...
    value: function render() {
      var _props = this.props,
          transactionHistory = _props.transactionHistory,
          selectedPortfolioItem = _props.selectedPortfolioItem;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          null,
          transactionHistory && Object.entries(transactionHistory).reverse().filter(function (item) {
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, null)(IndivTrans);
...
var TradeBox = function (_React$Component) {
  _inherits(TradeBox, _React$Component);

  function TradeBox(props) {
    _classCallCheck(this, TradeBox);

    var _this = _possibleConstructorReturn(this, (TradeBox.__proto__ || Object.getPrototypeOf(TradeBox)).call(this, props));

    _this.handleTrade = function (type) {
      var _this$props = _this.props,
      ...
      var quantity = selectedPortfolioItem_object.quantity,
          ...
          symbol = selectedPortfolioItem_object.symbol;
      ...
      if (type === "Sell" && _this.state.size > quantity) {
        ...
        setTimeout(function () {
          _this.setState({ isToolTipShowing: false });
        }, 2000);
  ...
  _createClass(TradeBox, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.state.isToolTipShowing && _react2.default.createElement(
          "span",
          null,
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    makeTradeThunk: function makeTradeThunk() {
      return dispatch(_thunks_for_Portfolio.makeTradeThunk.apply(undefined, arguments));
    }
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(TradeBox);
...
var AddSymbolBox = function (_React$Component) {
  _inherits(AddSymbolBox, _React$Component);

  function AddSymbolBox(props) {
    _classCallCheck(this, AddSymbolBox);

    var _this = _possibleConstructorReturn(this, (AddSymbolBox.__proto__ || Object.getPrototypeOf(AddSymbolBox)).call(this, props));

    _this.validateSymbol = function (text) {

      return !!_symbolHash2.default[text];
    };
    ...
    _this.handleChange = function (e) {
      ...
      if (_this.validateSymbol(text)) {
        ...
        _this.setState({
          stockName: _symbolHash2.default[text]
        });
      } else {
  ...
  _createClass(AddSymbolBox, [{
    ...
    value: function render() {
      var _state = this.state,
          stockName = _state.stockName,
          input = _state.input;


      return _react2.default.createElement(
        'div',
        { className: 'trade-box symbol-box', id: 'add-symbol-box' },
        _react2.default.createElement(
          'span',
          null,
          'Symbol'
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(AddSymbolBox);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          null,
          Object.entries(this.props.transactionHistory).reverse().filter(function (item) {
...
var AllWatchList = function (_React$Component) {
  ...
  function AllWatchList(props) {
    ...
    _this.handleEdit = function (item) {
      ...
      var LS_Key = _this.props.email + '-hideList';

      var newHidelist = void 0;
  ...
  _createClass(AllWatchList, [{
    ...
    value: function componentDidMount() {
      ...
      var LS_Key = this.props.email + '-hideList';
    ...
    value: function render() {
      ...
      var _props = this.props,
          portfolio = _props.portfolio,
          token_error = _props.token_error;
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('i', {
              className: 'fas fa-plus fa-plus-edit fa-' + ((0, _utils.isDesktop)() ? "2" : "7") + 'x',
              onClick: function onClick() {
          ...
          _react2.default.createElement(
            'div',
            null,
            token_error && _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement(
                'span',
                { className: 'error_message' },
                'Error validating account- please try signing in again.'
              ),
              _react2.default.createElement(
                'span',
                { className: 'error_message' },
            ...
            portfolio ? Object.entries(portfolio).sort().filter(function (item) {
              ...
              return _react2.default.createElement(
                'div',
                { key: i, className: 'watchlist-item-container' },
                _this2.state.edit && _react2.default.createElement('i', {
                  className: 'fas fa-' + (hideList.includes(symbol) ? "plus" : "minus") + ' fa-' + ((0, _utils.isDesktop)() ? "2" : "7") + 'x',
                  onClick: function onClick() {
                ...
                data && _react2.default.createElement(
                  'div',
                  { className: 'watchlist-item', style: { opacity: hideList.includes(symbol) ? ".5" : "1" } },
                  _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(
                      'span',
                      { style: { color: data.latestPrice < item[1].price ? "green" : "red" } },
                      ' ',
                      item[1].symbol
                    ),
                    _react2.default.createElement(
                    ...
                    '$',
                    item[1].price ? _react2.default.createElement(
                      'span',
                      { style: { color: data.latestPrice < item[1].price ? "green" : "red" } },
                      item[1].price
                    ) : _react2.default.createElement(
                      'span',
                      { style: { color: data.latestPrice > data.open ? "green" : "red" } },
                      data.latestPrice
                    )
                  ),
                  _react2.default.createElement(
            ...
            }) : _react2.default.createElement(_loadingDots2.default, { size: "10rem" })
          )
        ),
        isModalShowing && _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_AddSymbolBox2.default, { exit: this.closeModal })
          )
        )
      );
    }
...
exports.isTab = isTab;
var logoUrl = exports.logoUrl = "../assets/graphql_logo.png";

var blurb = exports.blurb = 'Graff Exchange, a real-time stock portfolio application built with a full stack: React, Redux, Sass, Socket.io, Node.js, GraphQL, Redis, PostgreSQL, and AWS.';
...
/* harmony import */ var _app_main__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_app_main__WEBPACK_IMPORTED_MODULE_2__);
...
const hydrateQuarterlyFinancialsThunk = ( symbol ) => async dispatch =>{
...
/* harmony import */ var _app_components_utils__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_app_components_utils__WEBPACK_IMPORTED_MODULE_0__);
...
//# sourceMappingURL=1.ce5a0a066b493b378a6f.js.map